...
public class DefaultSettingsConfig {
    ...
    @NotNull
    private static Map<String, TemplateSettingDTO> defaultTemplateSettingMapping() {
        ...
        map.put(service.getConfigName(), service);
        ...
        map.put(serviceImpl.getConfigName(), serviceImpl);
        ...
        map.put(mapperInterface.getConfigName(), mapperInterface);
        ...
        map.put(mapperXml.getConfigName(), mapperXml);
